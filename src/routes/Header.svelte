...
<nav class='{isNavOpen ? "open" : ""} relative'>
  ...
  <div class="flex flex-col sm:flex-row gap-[20px] sm:gap-[30px] sm:ml-[60px] ml-[30px] absolute bottom-[120px] sm:bottom-[150px] c-social">
    <a href="https://discord.com/invite/PQqmXUYYfD" target="_blank">
      <div class="flex justify-center gap-[20px] items-center border social-button">
...
<header
  id="nav"
  class="h-[100px] flex items-center justify-between px-[20px] sm:px-[13vw] lg:px-[8vw] z-50 sticky-nav {isPageTop ? "" : "background"}"
>
  <!-- svelte-ignore a11y-click-events-have-key-events -->
  <img
    on:click={backHome}
